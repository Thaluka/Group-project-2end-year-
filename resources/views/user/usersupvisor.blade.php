...
<html lang="en" dir="ltr">
  ...
  <section>
    <div class="row mt-4">
     ...
     <!-- <div class="card col-md-3 col-sm-4" style="width: 18rem;">-->
          <!--<ul class="list-group list-group-flush">
          <li class="list-group-item">Cras justo odio</li>
          <li class="list-group-item">Dapibus ac facilisis in</li>
          <li class="list-group-item">Vestibulum at eros</li>
        </ul>-->
        <div class="col-md-3 col-sm-3 mangocard card-body" id="butn">
          <a href="{{url('viewcomplain')}}" class="btn col-12 btn-primary btn-lg btn-block">Job Request</a>
          <a href="#" class="btn col-12 btn-primary btn-lg btn-block">Technican Available</a>
          <a href="#" class="btn col-12 btn-primary btn-lg btn-block">Technican Rankig</a>
          <a href="#" class="btn col-12 btn-primary btn-lg btn-block">Estimation</a>
        </div>
   </div>
  </section>
<!-- Optional JavaScript -->
